  ...
  return (
    ...
    <div className="placeContainer">
      ...
      <div className="places">
        ...
        <p>The Field Trip is a directory that is dedicated to helping you find Chicago's most beautiful and unique spaces. Whether you're new to Chicago or just looking to venture outside of your own neighborhood, we hope to introduce you to new places that will help you to find inspiration and share special experiences.</p>
